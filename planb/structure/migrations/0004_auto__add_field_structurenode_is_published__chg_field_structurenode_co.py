...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StructureNode.is_published'
        db.add_column('structure_structurenode', 'is_published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'StructureNode.content'
        db.alter_column('structure_structurenode', 'content', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'StructureNode.teaser'
        db.alter_column('structure_structurenode', 'teaser', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):
        # Deleting field 'StructureNode.is_published'
        db.delete_column('structure_structurenode', 'is_published')
