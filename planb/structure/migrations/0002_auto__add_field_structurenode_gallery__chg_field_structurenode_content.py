...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StructureNode.gallery'
        db.add_column('structure_structurenode', 'gallery',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gallery.Gallery'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'StructureNode.content'
        db.alter_column('structure_structurenode', 'content', self.gf('tinymce.models.HTMLField')())

        # Changing field 'StructureNode.teaser'
        db.alter_column('structure_structurenode', 'teaser', self.gf('tinymce.models.HTMLField')())

    def backwards(self, orm):
        # Deleting field 'StructureNode.gallery'
        db.delete_column('structure_structurenode', 'gallery_id')


        # Changing field 'StructureNode.content'
        db.alter_column('structure_structurenode', 'content', self.gf('django.db.models.fields.TextField')())

        # Changing field 'StructureNode.teaser'
        db.alter_column('structure_structurenode', 'teaser', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'structure.structurenode': {
            'Meta': {'ordering': "('tree_id', 'right')", 'object_name': 'StructureNode'},
