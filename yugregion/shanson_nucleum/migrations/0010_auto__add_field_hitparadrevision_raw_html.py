...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HitParadRevision.raw_html'
        db.add_column('shanson_nucleum_hitparadrevision', 'raw_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HitParadRevision.raw_html'
        db.delete_column('shanson_nucleum_hitparadrevision', 'raw_html')
