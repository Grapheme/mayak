...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shanson_nucleum_promo', 'program',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shanson_nucleum.Programs'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Promo.program'
        db.delete_column('shanson_nucleum_promo', 'program_id')
