...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HitParadItem'
        db.create_table('shanson_nucleum_hitparaditem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_published', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('revision', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shanson_nucleum.HitParadRevision'], null=True, blank=True)),
            ('pos', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True, blank=True)),
            ('img', self.gf('django.db.models.fields.CharField')(max_length=762, null=True, blank=True)),
            ('singer', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('songer', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('weeks', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True, blank=True)),
            ('dynamic', self.gf('django.db.models.fields.CharField')(default='none', max_length=254, null=True, blank=True)),
        ))
        db.send_create_signal('shanson_nucleum', ['HitParadItem'])

        # Adding model 'HitParadRevision'
        db.create_table('shanson_nucleum_hitparadrevision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_published', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('shanson_nucleum', ['HitParadRevision'])


        # Changing field 'Listeners.m_time'
        db.alter_column('shanson_nucleum_listeners', 'm_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Deleting model 'HitParadItem'
        db.delete_table('shanson_nucleum_hitparaditem')

        # Deleting model 'HitParadRevision'
        db.delete_table('shanson_nucleum_hitparadrevision')


        # Changing field 'Listeners.m_time'
        db.alter_column('shanson_nucleum_listeners', 'm_time', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        'shanson_nucleum.hitparaditem': {
            ...
            'songer': ('django.db.models.fields.CharField', [], {'max_length': '254', 'null': 'True', 'blank': 'True'}),
