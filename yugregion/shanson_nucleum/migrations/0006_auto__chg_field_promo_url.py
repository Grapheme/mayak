...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('shanson_nucleum_promo', 'url', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Promo.url'
        db.alter_column('shanson_nucleum_promo', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'shanson_nucleum.programsarchive': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 29, 0, 0)'}),
            'description': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'time_e': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 5, 29, 0, 0)'}),
            'time_s': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 5, 29, 0, 0)'})
        },
