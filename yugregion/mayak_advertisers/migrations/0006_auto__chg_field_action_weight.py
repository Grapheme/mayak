...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Action.weight'
        db.alter_column('mayak_advertisers_action', 'weight', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Action.weight'
        db.alter_column('mayak_advertisers_action', 'weight', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
