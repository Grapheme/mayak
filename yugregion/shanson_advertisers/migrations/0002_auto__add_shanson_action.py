...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Shanson_Action'
        db.create_table('shanson_advertisers_shanson_action', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_published', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('date_s', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 4, 1, 0, 0))),
            ('date_e', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 4, 1, 0, 0))),
        ...
        db.send_create_signal('shanson_advertisers', ['Shanson_Action'])


    def backwards(self, orm):
        # Deleting model 'Shanson_Action'
        db.delete_table('shanson_advertisers_shanson_action')
