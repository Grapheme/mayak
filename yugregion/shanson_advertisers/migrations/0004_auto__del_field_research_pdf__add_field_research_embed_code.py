...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'research.pdf'
        db.delete_column('shanson_advertisers_research', 'pdf')

        # Adding field 'Research.embed_code'
        db.add_column('shanson_advertisers_research', 'embed_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'research.pdf'
        db.add_column('shanson_advertisers_research', 'pdf',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'Research.embed_code'
        db.delete_column('shanson_advertisers_research', 'embed_code')
