...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('shanson_advertisers_partners', (
        ...
        db.send_create_signal('shanson_advertisers', ['Partners'])


    def backwards(self, orm):
        # Deleting model 'Partners'
        db.delete_table('shanson_advertisers_partners')
    ...
    models = {
        ...
        'shanson_advertisers.shanson_action': {
            ...
            'date_e': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 19, 0, 0)'}),
            'date_s': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 19, 0, 0)'}),
            'description': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
