    ...
    function addFlake(initial)
    {
        ...
        var sizes = [
            ...
            },
            {
                r: 0.6,
                css: {
                    fontSize: 37 + Math.floor(Math.random() * 20) + 'px',
                    textShadow: '9999px 0 2px #C4D3E2'
                },
                v: 6
            },
            {
                r: 0.2,
                css: {
                    fontSize: 65 + Math.floor(Math.random() * 30) + 'px',
                    textShadow: '9999px 0 6px #B3C9DF'
                },
                v: 12
            },
            {
                ...
                css: {
                    ...
                    textShadow: '9999px 0 24px #D3DDE7'
                },
                v: 20
            }
        ];
