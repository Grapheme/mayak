...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.tiser'
        db.add_column('mayak_nucleum_discussion', 'tiser',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Discussion.photo'
        db.alter_column('mayak_nucleum_discussion', 'photo', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))

    def backwards(self, orm):
        # Deleting field 'Discussion.tiser'
        db.delete_column('mayak_nucleum_discussion', 'tiser')


        # Changing field 'Discussion.photo'
        db.alter_column('mayak_nucleum_discussion', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        'mayak_nucleum.discussion': {
            ...
            'tiser': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
        ...
        'mayak_nucleum.programsarchive': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)'}),
            'description': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'time_e': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)'}),
            'time_s': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)'})
        },
