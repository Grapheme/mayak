...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Promo.programs'
        db.add_column('mayak_nucleum_promo', 'programs',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mayak_nucleum.Programs'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Promo.url'
        db.alter_column('mayak_nucleum_promo', 'url', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'Promo.programs'
        db.delete_column('mayak_nucleum_promo', 'programs_id')


        # Changing field 'Promo.url'
        db.alter_column('mayak_nucleum_promo', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

    models = {
        'mayak_nucleum.hospes': {
            'Meta': {'ordering': "('date', 'surname', 'name')", 'object_name': 'Hospes'},
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 26, 0, 0)'}),
