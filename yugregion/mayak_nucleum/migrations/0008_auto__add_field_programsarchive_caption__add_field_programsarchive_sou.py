...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProgramsArchive.caption'
        db.add_column('mayak_nucleum_programsarchive', 'caption',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'ProgramsArchive.soundcloud'
        db.add_column('mayak_nucleum_programsarchive', 'soundcloud',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProgramsArchive.caption'
        db.delete_column('mayak_nucleum_programsarchive', 'caption')

        # Deleting field 'ProgramsArchive.soundcloud'
        db.delete_column('mayak_nucleum_programsarchive', 'soundcloud')
