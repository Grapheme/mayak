...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mayak_nucleum_programsarchive', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_published', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('program', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mayak_nucleum.Programs'])),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 27, 0, 0))),
            ('time_s', self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2013, 3, 27, 0, 0))),
            ('time_e', self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2013, 3, 27, 0, 0))),
            ('description', self.gf('tinymce.models.HTMLField')(blank=True)),
        ))
        db.send_create_signal('mayak_nucleum', ['ProgramsArchive'])

        # Adding model 'ProgramsArchivePhoto'
        db.create_table('mayak_nucleum_programsarchivephoto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_published', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('program', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mayak_nucleum.ProgramsArchive'])),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('description', self.gf('tinymce.models.HTMLField')(blank=True)),
            ('weight', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
        db.send_create_signal('mayak_nucleum', ['ProgramsArchivePhoto'])


    def backwards(self, orm):
        # Deleting model 'ProgramsArchive'
        db.delete_table('mayak_nucleum_programsarchive')

        # Deleting model 'ProgramsArchivePhoto'
        db.delete_table('mayak_nucleum_programsarchivephoto')


    models = {
        'mayak_nucleum.hospes': {
            'Meta': {'ordering': "('date', 'surname', 'name')", 'object_name': 'Hospes'},
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'}),
        ...
        'mayak_nucleum.programsarchive': {
            'Meta': {'object_name': 'ProgramsArchive'},
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'}),
            'description': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mayak_nucleum.Programs']"}),
            'time_e': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'}),
            'time_s': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'})
        },
        'mayak_nucleum.programsarchivephoto': {
            'Meta': {'object_name': 'ProgramsArchivePhoto'},
            'description': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
